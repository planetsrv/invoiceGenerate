...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Agu 2026 pada 11.52
...
INSERT INTO `customer_accounts` (`id`, `customer_prefix`, `username`, `password`, `full_name`, `is_active`, `created_at`) VALUES
...
(40, '14H', '@14hiah', 'Iah', 'Iah', 1, '2026-08-04 04:17:03'),
(41, 'YN1', '@yn1yeni', 'Yeni', 'Yeni', 1, '2026-08-04 08:42:46');
...
INSERT INTO `customer_paket_harga` (`id`, `prefix`, `paket`, `harga`) VALUES
...
(339, '14H', '3 JAM', 1500.00),
(340, '14H', '6 JAM', 2500.00),
(341, '14H', '12 JAM', 4500.00),
(342, '14H', 'VC 12 JAM', 2500.00),
(343, '14H', '24 JAM', 6000.00),
(344, '14H', 'VC 24 JAM', 4500.00),
(345, '14H', '3 HARI', 9000.00),
(346, '14H', '7 HARI', 17000.00),
(347, '14H', '30 HARI', 55000.00),
(348, 'YN1', '3 JAM', 1500.00),
(349, 'YN1', '6 JAM', 2500.00),
(350, 'YN1', '12 JAM', 4500.00),
(351, 'YN1', 'VC 12 JAM', 2500.00),
(352, 'YN1', '24 JAM', 6000.00),
(353, 'YN1', 'VC 24 JAM', 4500.00),
(354, 'YN1', '3 HARI', 9000.00),
(355, 'YN1', '7 HARI', 16000.00),
(356, 'YN1', '30 HARI', 50000.00);
...
INSERT INTO `prefix_customers` (`id`, `prefix`, `nama_pelanggan`, `alamat`, `telepon`, `billing_id`) VALUES
(2, 'AKH', 'Arikah', '', '', 1),
(3, 'NCN', 'Ncun', '', '', 1),
(4, 'UJH', 'Juheni', '', '', 1),
(5, 'NN1', 'Sahani', '', '', 4),
...
ALTER TABLE `customer_accounts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `customer_awalan` (`customer_prefix`),
...
ALTER TABLE `customer_paket_harga`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_cust_paket` (`prefix`,`paket`);
...
ALTER TABLE `invoices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_file_awalan` (`file_id`,`prefix`),
  ADD KEY `idx_invoice_customer` (`prefix`,`file_id`);
...
ALTER TABLE `prefix_customers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `awalan` (`prefix`),
  ADD KEY `idx_billing_id` (`billing_id`),
  ADD KEY `idx_customer_name` (`nama_pelanggan`,`prefix`);
...
ALTER TABLE `rekap`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_file_awalan_paket` (`file_id`,`prefix`,`paket`);
